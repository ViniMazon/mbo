      ...
      <div class="box">
        ...
        <ul>
          ...
          ?>
            ...
            <li>
              <div class='item'> <?php echo $ano; ?> </div>
              <table>
                <tr>
                ...
                <tr class='btns'>
                  <td> <button> <a href='visualizarciclo.php?id=<?php echo $id?>'> Visualizar </a> </button> </td>
                  <td> <button> <a href='editarciclo.php?id=<?php echo $id?> '> Editar </a> </button> </td>
                </tr>
              </table>
            </li>
