...
<body>
    ...
    <div class="corpo">
        <form action="ope_ni.php" method="post">
            <div class="circle">
                <select name="ano[<?php echo $cod_ciclo ?>]" disabled>
                    <?php
                    ...
                    if ($ciclo_ano == null) { ?>
                        ...
                        <option value='' selected disabled>Sem ano definido</option>
            ...
            ?>
                <div id='box1'>
                    ...
                    <table class='tabela'>
                        ...
                        <tr>
                            <td> <select name="categoria[<?php echo $cod_item ?>]" disabled>
                                    <?php
                            ...
                            <td colspan='2'>
                                <textarea placeholder='insira o objetivo' cols='50' rows='3' name="objetivo[<?php echo $cod_item ?>]" disabled><?php echo $objetivo_mensuravel; ?></textarea>
                            </td>
                        </tr>
                        <tr class='top'>
                        ...
                        <tr>
                            <td>
                                <input type='text' size='30px' placeholder='insira o campo de ação' name="campo_acao[<?php echo $cod_item ?>]" value="<?php echo $campo_acao; ?>" disabled>
                            </td>
                            <td>
                                <input type='date' name="prazo[<?php echo $cod_item ?>]" value="<?php echo $prazo; ?>" disabled>
                            </td>
                            <td>
                                <input type='text' size='5px' placeholder='ex: 0.5' name="peso[<?php echo $cod_item ?>]" value="<?php echo $peso; ?>" disabled>
                            </td>
                        </tr>
                        <tr class='top'>
                            <td>Status:</td>
                        ...
                        <tr>
                            <td>
                                <input type='text' size='30px' placeholder='Insira o status do item' name="status[<?php echo $cod_item ?>]" value="<?php echo $status; ?>" disabled>
                            </td>
                            <td colspan='2'>
                                <input type='text' size='30px' placeholder='Insira como será a implentação' name="implementacao[<?php echo $cod_item ?>]" value="<?php echo $implementacao; ?>" disabled>
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="finalizar">
                <input type="submit" name="finalizar" value="Voltar">
            </div>
        </form>
...
if (isset($_POST['finalizar'])) {
    ...
    $ins_ano = "UPDATE ciclo SET ano=$ano WHERE id=$cod_ciclo";

    $up_ano = mysqli_query($conn, $ins_ano);
}
